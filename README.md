...
# 2. 批量生成图像
node scripts/batch-generate-images.js novels/正文-storyboard.json outputs/images

# 3. 批量生成配音
node scripts/batch-tts.js novels/正文-storyboard.json outputs/audio

# 4. 合成视频
./scripts/compose-video.sh novels/正文-storyboard.json outputs/videos/final.mp4 outputs/images outputs/audio
```
